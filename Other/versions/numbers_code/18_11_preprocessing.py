...
data['Keywords'] = preprocess_keyword_column(data['Keywords'], min_frequency=minimum_frequency)

print("\n")

for feature in categorical_features:
    unique_values_count = data[feature].nunique()
    print(f"Number of unique values in '{feature}': {unique_values_count} after mininum frequency of {minimum_frequency}")
